                                  ...
                                  <div class="single-item">
                                      ...
                                      <div class="inner">
                                          ...
                                          <ul class="confirm-list clearfix">
                                             <?php if($am->status=='1'): ?>
                                                <li><a href="<?php echo e(url('changeappointment').'/3/'.$am->id); ?>"><i class="fas fa-check"></i><?php echo e(__("message.Accept")); ?></a></li>
                                                <li><a href="<?php echo e(url('changeappointment').'/5/'.$am->id); ?>"><i class="fas fa-times"></i><?php echo e(__("message.Cancel")); ?></a></li>
                                             <?php elseif($am->status=='3'): ?>
                                             <!-- href="<?php echo e(url('changeappointment').'/4/'.$am->id); ?>" -->
                                                <li><a href="javascript:void(0)" onclick="completeappointment('<?php echo e($am->id); ?>')" data-toggle="modal" data-target="#myModal"><i class="fas fa-check"></i><?php echo e(__("message.Complete")); ?></a></li>
                                                <li><a href="<?php echo e(url('changeappointment').'/0/'.$am->id); ?>"><i class="fas fa-times"></i><?php echo e(__("message.Absent")); ?></a></li>
                                             <?php endif; ?>
                                          </ul>
                                      </div>
                                  </div>
