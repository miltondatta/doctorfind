...
<html lang="en">
   ...
   <body class="login-sec-bg">
      <div id="layout-wrapper">
         <header id="page-topbar">
            <div class="navbar-header login-sec-bg">
               <div class="d-flex">
                  <div class="navbar-brand-box">
                     <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark">
                     <span class="logo-sm">
                     <img src="<?php echo e(Session::get('logo')); ?>" alt="" height="100" />
                     </span>
                     <span class="logo-lg">
                     <img src="<?php echo e(Session::get('logo')); ?>" alt="" height="100" />
                     </span>
                     ...
                     <span class="logo-lg">
                     <img src="<?php echo e(Session::get('logo')); ?>" alt="" height="100" width="100" />
                     </span>
                     </a>
                  </div>
         ...
         <div class="vertical-menu login-sec-bg">
            <div class="navbar-brand-box">
               <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark">
               <span class="logo-sm">
               <img src="<?php echo e(Session::get('logo')); ?>" alt="" height="100" />
               ...
               <span class="logo-lg">
               <img src="<?php echo e(Session::get('logo')); ?>" alt="" height="60" />
               </span>
               </a>
               <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-light">
               <span class="logo-sm">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     <div class="text-sm-right d-none d-sm-block">
                        <i class="mdi mdi-heart text-danger"></i> <?php echo e(__("message.by")); ?> <a href="#/" target="_blank" class="text-reset"><?php echo e(__("message.System Name")); ?></a>
                     </div>
                  </div>
               </div>
            </div>
...
</html><?php /**PATH E:\xampp\htdocs\doctorfind\resources\views/admin/layout.blade.php ENDPATH**/ ?>