             ...
             <?php if(isset($paymentdetail['braintree_is_active'])&&$paymentdetail['braintree_is_active']=='1'): ?>
                  <div class="col-md-4 types flex justify-space-between">
                    <div class="type" id="pay_braintree" onclick="changepayselection('braintree')">
                        <div class="logo">
                          <img src="<?php echo e(asset('public/img/braintree_new.png')); ?>" style="height: 60px;" />
                        </div>
                      </div>      
                  </div>
              <?php endif; ?>
              <?php if(isset($paymentdetail['razorpay_is_active'])&&$paymentdetail['razorpay_is_active']=='1'): ?>
                  <div class="col-md-4 types flex justify-space-between">
                      <div class="type" id="pay_razorpay" onclick="changepayselection('razorpay')">
                        <div class="logo">
                          <img src="<?php echo e(asset('public/img/razorpay.png')); ?>" style="height: 60px;" />
                        </div>
                      </div>      
                  </div>
              <?php endif; ?>
              ...
              <div class="col-md-4 types flex justify-space-between">
                <div class="type" id="pay_paytm" onclick="changepayselection('paytm')">
                    <div class="logo">
                      <img src="<?php echo e(asset('public/img/paytm.png')); ?>" style="height: 60px;" />
                    </div>
                  </div>      
              </div>
              <?php endif; ?>
              ...
              <div class="col-md-6 types flex justify-space-between">
                <div class="type" id="pay_paystack" onclick="changepayselection('paystack')">
                    <div class="logo"> 
                      <img src="<?php echo e(asset('public/img/paystack.png')); ?>" style="height: 60px;" />
                    </div>
                  </div>      
              </div>
              <?php endif; ?>
              ...
              <div class="col-md-6 types flex justify-space-between">
                <div class="type" id="pay_flutterwave" onclick="changepayselection('flutterwave')">
                    <div class="logo">
                       ...
                       <img src="<?php echo e(asset('public/img/flutterwave.png')); ?>" style="height: 60px;" />
                    </div>
                  </div>      
              </div>
              <?php endif; ?>
         ...
         <div id="braintree_pay" class="payfrom">
                     <?php if(isset($paymentdetail['braintree_is_active'])&&$paymentdetail['braintree_is_active']=='1'): ?>
                      ...
                      <div id="paystack_pay" style="display: none" class="payfrom">
                        <?php if(isset($paymentdetail['paystack_is_active'])&&$paymentdetail['paystack_is_active']=='1'): ?>
                          <form action="<?php echo route('paystack-payment'); ?>" method="POST" >
                            <?php echo e(csrf_field()); ?>

                            <input id="book_appointment_id" name="id" type="hidden" value="<?php echo e($data->id); ?>">
                              <script src="https://js.paystack.co/v1/inline.js"></script>
                              <div id="orderplacedbtn">
                                <button type="submit" class="btn btn-primary"> <?php echo e(__("message.Pay")); ?> </button> 
                             </div>
                         </form>
                        <?php endif; ?>
                      </div>
                      <div id="paytm_pay" style="display: none" class="payfrom">
                         <?php if(isset($paymentdetail['paytm_is_active'])&&$paymentdetail['paytm_is_active']=='1'): ?>
                         <form action="<?php echo e(route('paytm-payment')); ?>" method="post" id="paytmform" >
                             <?php echo e(csrf_field()); ?>
                      ...
                      <div id="flutterwave_pay" style="display: none" class="payfrom">
                         <?php if(isset($paymentdetail['rave_is_active'])&&$paymentdetail['rave_is_active']=='1'): ?>
                            <form action="<?php echo route('rave-payment'); ?>" method="POST" >
                              <input id="book_appointment_id" name="id" type="hidden" value="<?php echo e($data->id); ?>">
                                <?php echo e(csrf_field()); ?>
...
</html><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/payment.blade.php ENDPATH**/ ?>