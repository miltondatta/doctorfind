      ...
      <div id="layout-wrapper">
            ...
            <div class="navbar-header login-sec-bg">
               <div class="d-flex">
                  <div class="navbar-brand-box">
                     ...
                     <span class="logo-sm">
                     <img src="{{Session::get('logo')}}" alt="" height="100" />
                     </span>
                     <span class="logo-lg">
                     <img src="{{Session::get('logo')}}" alt="" height="100" />
                     </span>
                     ...
                     <span class="logo-lg">
                     <img src="{{Session::get('logo')}}" alt="" height="100" width="100" />
                     </span>
                     </a>
                  </div>
         ...
         <div class="vertical-menu login-sec-bg">
            <div class="navbar-brand-box">
               ...
               <span class="logo-lg">
               <img src="{{Session::get('logo')}}" alt="" height="60" />
               </span>
               </a>
               <a href="{{url('admin/dashboard')}}" class="logo logo-light">
               <span class="logo-sm">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6">
                     <div class="text-sm-right d-none d-sm-block">
                        <i class="mdi mdi-heart text-danger"></i> {{__("message.by")}} <a href="#/" target="_blank" class="text-reset">{{__("message.System Name")}}</a>
                     </div>
                  </div>
               </div>
            </div>
