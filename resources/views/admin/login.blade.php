            ...
            <div class="row">
               <div class="col-lg-12">
                  <!--<div class="text-center">
                     ...
                     <img src="{{Session::get('logo')}}" alt="" height="110" class="logo logo-dark" />
                     <img src="{{Session::get('logo')}}" alt="" height="110" class="logo logo-light" />
                     </a>
                  </div> -->
               </div>
            </div>
            <div class="row align-items-center justify-content-center">
               <div class="col-md-8 col-lg-6 col-xl-5">
                  ...
                  <div class="mt-5 text-center">
                     <p style="color:red">© {{date('Y')}} {{__("message.System Name")}} <i class="mdi mdi-heart text-danger"></i> {{__("message.by Admin Panel")}}</p>
                  </div>
               </div>
            </div>
         </div>
